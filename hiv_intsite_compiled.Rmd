...
site_annot_graph <- ggplot(df_anno, aes(x = x_axis, y = percent_feature, fill = feature)) +
...
saveRDS(site_annot_graph, glue("{fig_rds_prefix}/site_annot_graph.rds"))
ggsave(filename = "figs/site_annot_subset.svg", plot = site_annot_graph, device = "svg", width = 9, height = 6)
```
